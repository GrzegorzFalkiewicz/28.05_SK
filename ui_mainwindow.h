...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        ustawA->setSingleStep(0.100000000000000);
        ustawA->setValue(5.000000000000000);
        ...
        ustawKpid->setSingleStep(0.100000000000000);
        ...
        ustawTd->setSingleStep(0.100000000000000);
        ...
        ustawTi->setSingleStep(0.100000000000000);
