...
public:
    ...
    void setupUi(QDialog *Dialog_ARX)
    {
        ...
        SpinBox_A1->setSingleStep(0.100000000000000);
        SpinBox_A1->setValue(-0.400000000000000);
        ...
        SpinBox_A2->setSingleStep(0.100000000000000);
        ...
        SpinBox_A3->setSingleStep(0.100000000000000);
        ...
        SpinBox_B1->setSingleStep(0.100000000000000);
        SpinBox_B1->setValue(0.600000000000000);
        ...
        SpinBox_B2->setSingleStep(0.100000000000000);
        ...
        SpinBox_B3->setSingleStep(0.100000000000000);
